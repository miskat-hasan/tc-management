...
const Page = () => {
  ...
  return (
    <div className="flex flex-col gap-[12.5px] lg:gap-[25px]">
      ...
      {/* Search filters */}
      <div className="px-[16px] py-[16px] lg:px-[32px] lg:py-[32px] bg-white rounded-[16px] flex flex-wrap gap-[12px] lg:gap-[24px]">
        <CustomSelect
          id="dates"
          label="Dates"
        ...
        <CustomSelect
          ...
          placeholder="Training Sites"
          options={[
            { value: "Wayne Halfway", label: "Wayne Halfway" },
            {
              value: "Code Blue CPR Services...",
              label: "Code Blue CPR Services...",
            },
            {
              value: "TS26570 Concierge Healt...",
              label: "TS26570 Concierge Healt...",
            },
            {
              value: "TS38737 Team Centurion",
              label: "TS38737 Team Centurion",
            },
            { value: "Reminington College", label: "Reminington College" },
          ]}
          onChange={(val) => handleSelectChange("Training Sites", val)}
          className="flex-1"
        />
